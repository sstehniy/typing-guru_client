...
const PATCH_TODOS_AFTER_STATE_UPDATE = "PATCH_TODOS_AFTER_STATE_UPDATE";
...
const SET_STATE_AFTER_UPDATE = "SET_STATE_AFTER_UPDATE";
const RESET_STATE_AFTER_UPDATE = "RESET_STATE_AFTER_UPDATE";
...
export default {
  ...
  SET_FILTER,
  RESET_FILTER,
  PATCH_TODOS_AFTER_STATE_UPDATE,
  ...
  INIT_USER_FAILED,
  REMOVE_USER,
  SET_STATE_AFTER_UPDATE,
  RESET_STATE_AFTER_UPDATE,
};
